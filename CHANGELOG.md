...
## [0.0.35] - 2024-10-29
### Fixed
- variable scope for critical counter in RabbitMq process_pool

## [0.0.34] - 2024-10-29
### Changed
- to fit upstream change to Aye-aye - TaskComplete message structure

## [0.0.33] - 2024-10-28
### Changed
- to fit upstream change to Aye-aye - iterators for :meth:`partition_slice` and :meth:`Model.partition_subtask_complete`
